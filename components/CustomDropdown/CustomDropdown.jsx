    ...
    const dropDownMenu = (
      <MenuList role="menu" className={classes.menuList}>
        {dropdownHeader !== undefined ? (
          ...
          >
            {intl.formatMessage({ defaultMessage: "dropdownHeader"})}
          </MenuItem>
        ) : null}
        {dropdownList.map((prop, key) => {
          if (prop.divider) {
            ...
            return (
              ...
              >
                {intl.formatMessage({ defaultMessage: "prop"})}
              </MenuItem>
            );
          }
          return (
        ...
        <div className={buttonText !== undefined ? "" : classes.target}>
          ...
          >
            {buttonIcon !== undefined ? (
              <Icon className={classes.buttonIcon}>{intl.formatMessage({ defaultMessage: "buttonIcon"})}</Icon>
            ) : null}
...
export default injectIntl(withStyles(customDropdownStyle)(CustomDropdown)) ;
