...
class Wizard extends React.Component {
  ...
  render() {
    const { classes, title, subtitle, color, steps } = this.props;  const intl = this.props.intl; 
    return (
      <div className={classes.wizardContainer} ref="wizard">
        <Card className={classes.card}>
          <div className={classes.wizardHeader}>
            ...
            <h5 className={classes.subtitle}>{intl.formatMessage({ defaultMessage: "subtitle"})}</h5>
          </div>
...
export default injectIntl (withStyles(wizardStyle)(Wizard)
