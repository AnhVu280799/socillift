  ...
  return (
    <Card className={cardClasses}>
      <CardContent className={classes.cardContent}>
        <h6 className={classes.cardTitle}>{intl.formatMessage({ defaultMessage: "title"})}</h6>
        <div className={iconWrapper}>
          <props.icon className={classes.icon} />
        </div>
        <h3 className={cardPrice}>{price}</h3>
        <p className={classes.cardDescription}>{intl.formatMessage({ defaultMessage: "description"})}</p>
...
export default injectIntl (withStyles(pricingCardStyle)(PricingCard)) ;
