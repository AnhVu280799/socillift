export default theme => ({
    ...
    sidebarButton: {
        ...
        minWidth: "40px",
        margin: "0",
        boxShadow: `0px 2px 2px 0 ${theme.colors.grey(0.14)}, 0px 1px 5px 0 ${theme.colors.grey(0.12)}`,
    ...
    infoField: { width: 'fit-content' },
    infoValue: { width: 'fit-content', marginLeft: '10px' },
    tooltipField: {
        ...theme.font.default,
        color: theme.colors.grey(1.0),
        fontSize: '13px',
